    ...
    <div class="relative justify-center min-h-screen bg-white-300 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @endif
			...
			<div style="margin-left:-4px;margin-top:-4px;margin-bottom:-4px">
				...
				<!--Aqui esta Las imagenes-->
				

				@foreach ($topics as $topic)

				<div class="rounded overflow-hidden shadow-lg" style="height: 100%; width: 20%; display: inline-block; float:right; margin-left: 2%; margin-right: 3%; margin-top: 1%; margin-bottom: 2%;">
                    <img class="w-full" src="{{$topic->image}}" >
                    <div class="px-6 py-4">
                        <a data-hook="deviation_link" href="{{route('topics.show',['topic'=>$topic->id])}}">
                        <div class="font-bold text-xl mb-2">{{$topic->name}}</div></a>
